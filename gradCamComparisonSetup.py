...
classOfInput = inputImagePath.split('/')[-1].split('_')[2] # This is only valid for CIFAR-10. based on the old code
# This will be changed later. Add the new version in the next line and comment this out later. IF needed
# plt.imshow(img)
...
with open(classDictFile,'r') as fH:
    lines = fH.readlines()
...
grayscale_cam = gradCam(input_tensor=inputTensor, targets=targets)
